 ...
 * 800x600 clock gate retains the live vertical raster; P6d's 640x480 gate uses
 * the complete databook-derived timing image and is the first real resolution
 * change. DB019-B section 9.2 (PDF pp.66-67) gives the SR12/SR13 + Misc Output
 * + SR15 bit-5 load order; sections 16/18 define the CRTC bytes generated by
